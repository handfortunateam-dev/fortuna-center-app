...
import { BlogAuthor, CreateBlogPostData } from "@/features/blog/interfaces";
...
export default function AdministrativeCreateBlogPostPage() {
  ...
  const handleSubmit = async (data: CreateBlogPostData) => {
    try {
      ...
      router.push(NAV_URL.ADMINISTRATIVE.POST_ARTICLES);
    } catch (error: unknown) {
      const errorMessage =
